      ...
      >
        {({ zoomIn, zoomOut, resetTransform }) => (
          <>
            <div className="flex-1 w-full h-full flex items-center justify-center overflow-hidden cursor-grab active:cursor-grabbing">
              ...
              >
                <HTMLFlipBook
                  ...
                  // =============================
                  // CHANGED: Disabled mouse/touch events on the book itself
                  // =============================
            ...
            ============================= */}
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-black/70 backdrop-blur-md px-6 py-3 rounded-full border border-white/10 shadow-2xl z-50">
