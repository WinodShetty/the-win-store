...
// const handleApplyCoupon = () => {
//   // యూజర్ ఎంటర్ చేసిన కోడ్‌కి ఉన్న ఎక్స్‌ట్రా స్పేసెస్ తీసేసి, దాన్ని క్యాపిటల్ లెటర్స్‌లోకి మార్చడం
//   const enteredCode = couponInput.trim().toUpperCase();

//   // ఫ్యూచర్‌లో మీరు coupons.codes లో స్మాల్ లెటర్స్ లో కోడ్స్ ఇచ్చినా సేఫ్ సైడ్ వర్క్ అవ్వడానికి
//   const validCodes = coupons.codes.map(code => code.toUpperCase());
...
export const CartDrawer = () => {
  ...
  const handleApplyCoupon = () => {
    ...
    if (validCodes.includes(enteredCode)) {
      // Connects to AppContext to apply the actual price drop
      setCoupon({
        discountType: "flat", 
